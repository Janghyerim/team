        ...
        <table  width="100%">
	        <tr>
	        	...
	        	<td align="center">
	        		...
	        		<input class="qna_btn" type="submit" value="검색하기"/>		
		        </td>
		        <td><button class="qna_btn"  type="button"  style="padding: 10px; border-radius: 5px;" onclick="location.href='/home/qnawrite'">작성하기</button></td>
