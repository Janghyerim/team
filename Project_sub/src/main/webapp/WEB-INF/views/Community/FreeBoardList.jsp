...
<div class="container">
	<div class="btn-group">
		<button type="button" class="btn btn-outline-info btn_free_cus"
...
<div class="container">
	<div class="table-group">
		<table border="1" style="width:100%; padding:2px;">
			<tr>
				<td align="center" class="table_free_cus"><select name="searchField">
						<option value="title">전체검색</option>
						<option value="content">제목</option>
						<option value="content">작성자</option>
				</select> <input type="text" name="searchWord" /> 
				<input type="submit" value="검색하기" class="btn_free_cus" />
					</td>
			</tr>
		</table>
		...
		<table class="table table-striped" style="width: 100%;">
			...
			<tr>
				...
				<td>2</td>
				<td>2023/01/01</td>
				<td class="text-center"><button type="button" class="btn btn-secondary btn-sm btn_free_cus">첨부
						파일</button></td>
			</tr>
			<tr>
				<td>2</td>
