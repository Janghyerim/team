	  ...
	  <div id="myDropdown2" class="dropdown-content">
   	...
   	<h4>필수입력 정보</h4>
				...
				<div class="text-center">
					<button class="submit1 btn_free_cus" onclick="location.href='/home/info'">정보수정</button>
					<button class="submit2 btn_free_cus" onclick="location.href='/home/main'">취소</button>
				</div>
