...
<div class="left-side-bar">
    ...
    <ul>
        <li>
            <li><a href="/admin/freeboard">게시판관리</a></li>
            <li><a href="/admin/qnaboard">Q&A관리</a></li>
            <li><a href="/admin/member_management">회원관리</a></li>
            <li><a href="/admin/club_Applist">동호회 신청 목록</a></li>
            <li><a href="/admin/club_management">동호회 관리</a></li>  
        </li>
    </ul>
</div>
								...
								<div class="container">
									<div class="row">
										...
										<button onclick="location.href='create_Announcement'"
											class="col-1 btn btn-primary btn-sm d-flex jsutify-content-end text-center">
											공지사항</button>
