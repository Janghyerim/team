				...
				<div class="row">
					<div class="col-lg-12 col-sm-12 col-xs-12">
						<div class="widget">
							...
							<div class="widget-header bordered-top bordered-palegreen widget_no_paddding">
							...
							<div class="widget-body">
								<form role="form">
									...
									<div class="form-group">
										활동 지역 : <input type="text" name="request" required>
										참여 성별 : <input type="text" name="request" required>
										<textarea style="width: 100%;"
											placeholder="위 두 항목은 필수항목이고 신청 이유는 자세하게 작성해주세요 " rows="5"></textarea>
									</div>
